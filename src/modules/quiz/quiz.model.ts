...
export interface QuizSessionDocument { id: string; playerId: string; playerName: string; categoryId: string; categoryName: string; questionCount: number; timePerQuestionSeconds: number; difficulty: string; questions: Snapshot[]; answers: Answer[]; status: "active" | "completed"; score: number; startedAt: Date; completedAt?: Date; }
